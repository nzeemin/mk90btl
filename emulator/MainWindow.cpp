...
void MainWindow_RegisterClass()
{
    ...
    wcex.hIcon          = LoadIcon(g_hInst, MAKEINTRESOURCE(IDI_MK90BTL));
    wcex.hCursor        = LoadCursor(NULL, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_BTNFACE + 1);
    wcex.lpszMenuName   = MAKEINTRESOURCE(IDC_MK90BTL);
...
{
    TCHAR buffer[100];
    wsprintf(buffer, _T("MK90BTL - version %s"), _T(MK90BTL_VERSION_STRING));
